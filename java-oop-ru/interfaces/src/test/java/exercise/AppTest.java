...
class AppTest {
    ...
    void testReversedSequence() {
        String actual = "fedcba";
        String expected = (new ReversedSequence("abcdef").toString());
        assertThat(actual).isEqualTo(expected);
        assertThat('e').isEqualTo(expected.charAt(1));
        assertThat(6).isEqualTo(expected.length());
        assertThat("edc").isEqualTo(expected.subSequence(1, 4));
    }
    // END
}
